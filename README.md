...
## THERE IS A NEW PREMIUM VERSION THAT IS STRIPPED DOWN TO SPAM/CATCH THAT WORKS 100% AND IS 100% UNDETECTABLE.
## THIS NEW VERSION IS NOT FREE AS THIS BOT DEVELOPMENT AS WELL AS SUPPORTING IT TAKES A LOT OF TIME.
## MUST DONATE MINIMUM OF $1 USD FOR NEW VERSION
> [Donate Here](https://donatebot.io/checkout/627563468035194881)
## ONCE I RECEIVE PAYMENT CONFIRMATION I WILL SEND A ZIP TO THE EMAIL USED TO DONATE.
## FROM THERE I CAN HELP SET UP AND SUPPORT.
